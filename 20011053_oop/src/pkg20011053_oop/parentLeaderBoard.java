 ...
 * @author MTI
 */
public class parentLeaderBoard extends javax.swing.JFrame {
    Exercise ex = _loginUI.loadedExercises.get(parentRecords.id-1);
    List<LeaderBoard> leaderBoard = ex.getLeaderBoard();
    
    /**
     * Creates new form leaderTable_page
     */
    public parentLeaderBoard() {
        initComponents();
        displayLeaderBoard();
    }
    /**
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(237, 217, 237));
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        setUndecorated(true);

        jButton1.setBackground(new java.awt.Color(190, 223, 230));
        ...
        jButton2.setBackground(new java.awt.Color(190, 223, 230));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jRadioButton2, javax.swing.GroupLayout.DEFAULT_SIZE, 156, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        setVisible(false);
        parentRecords frame = new parentRecords();
        frame.setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        setVisible(false);
        parentExerciseChart frame = new parentExerciseChart();
        frame.setVisible(true);
    ...
    private void displayLeaderBoard() {             // çocuktakinin aynısı anneye gösteriyor
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(parentLeaderBoard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new parentLeaderBoard().setVisible(true);
            }
        });
    }
